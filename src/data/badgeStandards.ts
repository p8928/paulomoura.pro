...
export const badgeStandards: BadgeStandard[] = [
  {
    ...
    definition: [
      'A maioria dos sites de empresas de alto padrão falha quando a qualidade da operação offline não encontra equivalente no digital. O visitante encontra sinais fracos demais para reconhecer o nível real da entrega.',
      'O M-HS é a declaração pública de que o projeto atende aos critérios estabelecidos pela metodologia Moura e que essa distância entre operação e presença digital foi tratada com rigor.',
    ],
  ...
  },
  {
    ...
    criteria: [
      ...
      { title: 'Reserva sem fricção', body: 'Acesso à reserva integrado à experiência digital, sem dissonância visual ou funcional e com clareza suficiente para preservar intenção no momento da decisão.' },
  ...
  },
  {
    ...
    criteria: [
      ...
      { title: 'Otimização para IA', body: 'Estrutura semântica, dados de entidade, sinais de autoria e organização editorial para que modelos de linguagem compreendam o titular com precisão, preservando trajetória, autoridade, produção e contexto correto de referência.' },
    ...
    notItems: ['Não é um site institucional com foto profissional e lista de serviços.', 'Não é um blog com calendário editorial por palavras-chave.', 'Não é um portfólio visual sem contexto narrativo.', 'Não é uma landing page de captação disfarçada de presença digital.', 'Não é indicado quando a autoridade relevante pertence apenas à instituição, não à pessoa.'],
  },
  {
    kind: 'msupreme',
    slug: 'moura-supreme',
    ...
    criteria: [
      ...
      { title: 'Profundidade estendida de direção', body: 'Projetos com ciclos ampliados de revisão, direção de arte mais próxima e presença direta nas decisões estratégicas, editoriais, técnicas e estéticas que definem o padrão final.' },
    ],
    audience: ['Marcas de luxo e clientes para quem o critério não tem teto e o nível de execução não é negociado apenas por orçamento.'],
